...
setPMoptions <- function(launch.app = TRUE) {
  ...
  app <- shiny::shinyApp(
    ...
    ui = bslib::page_fluid(
      ...
      tags$details(
        tags$summary("\U0001F4C1 Data File Reading"),
      ...
      # Formatting options
      tags$details(
        tags$summary("\U0001F4CF Formatting Options"),
      ...
      tags$details(
        tags$summary("\U0001F4CA Prediction Error Metrics"),
        br(),
      ...
      tags$details(
        tags$summary("\U0001F4C8 Report Generation"),
